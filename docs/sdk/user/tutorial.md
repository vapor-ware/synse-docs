...
!!! note
    There are different ways a plugin can be structured. This example does
...
## 5. Write handlers for the device(s)
...
## 6. Create and configure the plugin
...
!!! note
    There are more things that can be done during plugin setup, from registering
