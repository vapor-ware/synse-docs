...
[Pod](https://kubernetes.io/docs/concepts/workloads/pods/pod/) is restarted or scheduled
...
External communication can be secured by setting up something like [Nginx](https://www.nginx.com/)
...
generate a [self-signed cert](https://www.digitalocean.com/community/tutorials/openssl-essentials-working-with-ssl-certificates-private-keys-and-csrs)
or [bootstrap a CA to sign your certs](https://github.com/square/certstrap). In the example
